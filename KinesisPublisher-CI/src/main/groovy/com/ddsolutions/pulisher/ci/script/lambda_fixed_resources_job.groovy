...
import com.ddsolutions.pulisher.ci.LambdaFixedResourcesBuilder
import javaposse.jobdsl.dsl.JobParent

def factory = this as JobParent
def listOfEnvironment = ["dev", "qa", "prod"]
def component = "kinesis-lambda-kinesis-fixed-resources-job"

def emailId = "vivekmishra22117@gmail.com"
def description = "Pipeline DSL to create Kinesis Publisher Lambda fixed resource, Kinesis & DynamoDB"
...
new LambdaFixedResourcesBuilder(
        dslFactory: factory,
